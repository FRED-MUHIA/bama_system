...
class AgricultureOperationsController extends Controller
{
    ...
    private function farmRules(): array { return ['farm_code' => ['nullable', 'string', 'max:50'], 'name' => ['required', 'string', 'max:255'], 'location' => ['nullable', 'string'], 'gps_coordinates' => ['nullable', 'string'], 'county_region' => ['nullable', 'string'], 'total_area' => ['required', 'numeric', 'min:0'], 'measurement_unit' => ['required', 'in:Acres,Hectares,Sq Ft,Sq M'], 'ownership_type' => ['required', 'in:Owned,Leased,Contracted,Cooperative,Community'], 'manager_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'description' => ['nullable', 'string'], 'status' => ['required', 'in:Active,Inactive,Seasonal,Under Development']]; }
    private function branchRules(): array { return ['farm_id' => ['required', $this->exists('agriculture_farms')], 'branch_code' => ['nullable', 'string', 'max:50'], 'branch_id' => ['nullable', $this->exists('branches')], 'name' => ['required', 'string', 'max:255'], 'location' => ['nullable', 'string'], 'manager_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'status' => ['required', 'in:Active,Inactive']]; }
    ...
    private function workerRules(): array { return ['farm_id' => ['required', $this->exists('agriculture_farms')], 'field_id' => ['nullable', $this->exists('agriculture_fields')], 'user_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'worker_number' => ['nullable', 'string'], 'name' => ['required', 'string'], 'role_title' => ['required', 'string'], 'duties' => ['nullable', 'string'], 'work_schedule' => ['nullable', 'string'], 'activities_completed' => ['nullable', 'integer', 'min:0'], 'status' => ['required', 'in:Active,Inactive,Seasonal']]; }
    ...
    private function cropPlanRules(): array { return ['farm_id' => ['nullable', $this->exists('agriculture_farms')], 'field_id' => ['required', $this->exists('agriculture_fields')], 'season_id' => ['nullable', $this->exists('agriculture_farm_seasons')], 'crop_id' => ['required', $this->exists('agriculture_crops')], 'manager_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'variety' => ['nullable', 'string'], 'planting_date' => ['nullable', 'date'], 'expected_germination_date' => ['nullable', 'date'], 'expected_harvest_date' => ['nullable', 'date'], 'planned_acreage' => ['nullable', 'numeric', 'min:0'], 'seed_quantity' => ['nullable', 'numeric', 'min:0'], 'expected_yield' => ['nullable', 'numeric', 'min:0'], 'budget' => ['nullable', 'numeric', 'min:0'], 'status' => ['required', 'in:Draft,Approved,Preparing,Planted,Growing,Harvest Ready,Harvested,Closed,Cancelled']]; }
    ...
    private function veterinaryRules(): array { return ['farm_id' => ['nullable', $this->exists('agriculture_farms')], 'animal_id' => ['nullable', $this->exists('agriculture_animals')], 'herd_id' => ['nullable', $this->exists('agriculture_herds')], 'veterinarian_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'record_type' => ['required', 'in:Vaccination,Disease Case,Treatment,Deworming,Pregnancy Check,Veterinary Review'], 'record_date' => ['required', 'date'], 'diagnosis' => ['nullable', 'string'], 'medication' => ['nullable', 'string'], 'treatment_cost' => ['nullable', 'numeric', 'min:0'], 'next_due_date' => ['nullable', 'date'], 'recovery_status' => ['required', 'in:Monitoring,Recovered,Follow-up,Closed'], 'notes' => ['nullable', 'string']]; }
    ...
    private function irrigationRules(): array { return ['farm_id' => ['required', $this->exists('agriculture_farms')], 'field_id' => ['required', $this->exists('agriculture_fields')], 'operator_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'irrigation_type' => ['required', 'in:Drip,Sprinkler,Furrow,Pivot,Manual,Rain-fed'], 'starts_at' => ['required', 'date'], 'ends_at' => ['nullable', 'date', 'after_or_equal:starts_at'], 'water_quantity' => ['nullable', 'numeric', 'min:0'], 'pump' => ['nullable', 'string'], 'cost' => ['nullable', 'numeric', 'min:0'], 'iot_reference' => ['nullable', 'string'], 'status' => ['required', 'in:Scheduled,Running,Completed,Cancelled']]; }
    private function equipmentRules(): array { return ['farm_id' => ['required', $this->exists('agriculture_farms')], 'equipment_code' => ['nullable', 'string'], 'name' => ['required', 'string'], 'equipment_type' => ['required', 'in:Tractor,Plough,Harvester,Sprayer,Irrigation Pump,Generator,Milking Machine,Vehicle,Trailer,Other'], 'serial_number' => ['nullable', 'string'], 'purchase_date' => ['nullable', 'date'], 'purchase_cost' => ['nullable', 'numeric', 'min:0'], 'current_value' => ['nullable', 'numeric', 'min:0'], 'fuel_type' => ['nullable', 'string'], 'assigned_operator_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'fixed_asset_id' => ['nullable', $this->exists('fixed_assets')], 'status' => ['required', 'in:Available,In Use,Under Maintenance,Broken Down,Retired']]; }
    private function equipmentMaintenanceRules(): array { return ['farm_id' => ['nullable', $this->exists('agriculture_farms')], 'equipment_id' => ['required', $this->exists('agriculture_equipment')], 'technician_id' => ['nullable', $this->activeBusinessUserExistsRule()], 'service_date' => ['required', 'date'], 'service_type' => ['required', 'string'], 'parts_used' => ['nullable', 'string'], 'cost' => ['nullable', 'numeric', 'min:0'], 'next_service_date' => ['nullable', 'date'], 'meter_hours_reading' => ['nullable', 'numeric', 'min:0'], 'notes' => ['nullable', 'string'], 'status' => ['required', 'in:Scheduled,Completed,Deferred']]; }
