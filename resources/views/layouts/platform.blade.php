...
<head>
    ...
    <style>
        ...
        .owner-logo { width:96px; height:auto; display:block; border-radius:6px; background:#fff; padding:4px; }
    ...
    <div class="owner-shell">
        <aside class="owner-sidebar">
            <div class="owner-brand">
                <img class="owner-logo" src="{{ asset('images/bama-logo.png') }}" alt="BAMA">
                <div>
