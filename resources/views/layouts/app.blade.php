...
@if($currentUser && ! $isClientPortal)
    ...
    @php
        ...
        $hospitalityMobileItems = [
            ...
            ['label' => 'Invoices', 'route' => 'invoices.index', 'match' => 'invoices.*', 'icon' => 'bi-file-earmark-text'],
            ['label' => 'Quotations', 'route' => 'quotations.index', 'match' => 'quotations.*', 'icon' => 'bi-file-earmark-richtext'],
            ['label' => 'Receipts', 'route' => 'receipts.index', 'match' => 'receipts.*', 'icon' => 'bi-receipt'],
