    ...
    <header class="sticky top-0 z-50 border-b border-zinc-200 bg-[#FBFCFA]/95 backdrop-blur-xl">
        <nav class="mx-auto flex max-w-7xl items-center justify-between px-5 py-2">
            <a href="#top" class="flex items-center gap-3">
                <span class="grid h-9 w-9 place-items-center rounded-lg bg-[#00A651] text-sm font-black text-white">BA</span>
                <span class="text-lg font-black">BAMA</span>
            </a>
        ...
        <div class="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.2fr_2fr]">
            <div>
                <div class="flex items-center gap-3">
                    <span class="grid h-11 w-11 place-items-center rounded-lg bg-[#00A651] font-black text-white">BA</span>
                    <span class="font-black text-black">BAMA</span>
                </div>
